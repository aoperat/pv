    ...
    <header className="bg-teal-700 text-white shadow-md sticky top-0 z-10">
      <div className="max-w-4xl mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <nav className="flex gap-2 sm:gap-6 text-sm font-medium items-center">
          ...
          <button
            onClick={onSignOut}
            className="px-3 py-1 rounded-full transition text-teal-100 hover:bg-teal-600 flex items-center gap-1"
            title="로그아웃"
          >
            <LogOut size={14} />
          </button>
    ...
    return (
      <div className="max-w-4xl mx-auto px-4 py-10 animate-fade-in">
        <div className="flex items-center gap-2 mb-8">
          ...
          <h2 className="text-2xl font-bold text-stone-800">나의 루틴 & 습관</h2>
        </div>
      ...
      return (
        <div className="max-w-4xl mx-auto px-4 py-12 animate-fade-in">
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl font-bold text-stone-800 mb-2">진단 결과 분석</h2>
      ...
      <footer className="bg-stone-900 text-stone-400 py-8 px-4 mt-auto">
        <div className="max-w-4xl mx-auto text-center space-y-4">
          ...
          <p className="text-xs sm:text-sm max-w-xl mx-auto leading-relaxed">
            본 사이트에서 제공하는 정보는 일반적인 건강 증진을 위한 것이며, 전문적인
            의학적 조언을 대체할 수 없습니다. 심한 통증이나 부상이 있는 경우 반드시
            전문 의료진과 상담하세요.
          </p>
